...
class Product:
    ...
    def calculate_stats(self):
        opinions= pd.DataFrame.from_dict(self.opinion_to_dict())
...
class Opinion:
    ...
    def __init__(self, opinion_id,author, recomend, stars, content, pros, cons, up_votes, down_voes, published, purchased):
